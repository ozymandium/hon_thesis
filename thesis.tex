...
The effect this had upon readability and being able to intuitively interpret data was positive. Even though it was initially 
...
%%%% Earth %%%%
\subsection{Google Earth GUI} \label{finaldes_earth}

%%%% alerts

%% dev

\begin{figure}[ht] \centering \label{fig:earth_dev}
    \includegraphics[width=6.5in]{./figs/yellow_dev_no_leader_follower_centered.png}
    \caption{Following driver being signalled in Google Earth to correct left}
\end{figure}
