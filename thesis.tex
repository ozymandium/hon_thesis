...
\begin{figure}[ht] \centering \label{fig:hardwarelead}
    \includegraphics[width=5in]{./figs/leader_hardware.png}
...
\begin{figure}[ht] \centering \label{fig:hardwarefoll}
    \includegraphics[width=5in]{./figs/follower_hardware.png}
...
To examine performance in partially denied visibility, this test was conducted in both day- and night-time.
